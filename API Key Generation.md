## Check the ```pandas-datareader``` Documentation for the API's available for Data Collection <a href='https://pandas-datareader.readthedocs.io/en/latest/remote_data.html'>here</a>
